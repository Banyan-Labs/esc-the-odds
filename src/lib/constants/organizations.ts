...
export const ENGAGEMENT_MODELS: EngagementModel[] = [
  {
    ...
    includes: [
      ...
      "50 Bounce Forward workbooks distributed to local correctional facilities for the incarcerated",
    ],
  ...
  },
  {
    ...
    includes: [
      ...
      "Facilitation guides",
      "Community Engagement Subject Matter Expert toolkit",
    ...
    href: "/contact",
    image: "/assets/IMG_1832.JPG",
    imageAlt: "Men in blue sitting during Bounce Forward curriculum session",
  },
  {
    icon: Briefcase,
    ...
    href: "/programs",
    image: "/assets/IMG_8892.png",
    imageAlt: "Aaron standing with men in green holding certificates",
  },
];
